...
class kintukyHouseDropdown extends StatefulWidget {
  String label;
  ...
  @override
  _kintukyHouseDropdownState createState() {
    return _kintukyHouseDropdownState();
  }
}

class _kintukyHouseDropdownState extends State<kintukyHouseDropdown> {
  dynamic value ;
